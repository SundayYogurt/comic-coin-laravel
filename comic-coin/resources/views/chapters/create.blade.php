        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('chapters.store') }}" enctype="multipart/form-data">
                    ...
                    <!-- Chapter number -->
                    <div class="mb-4">
                        <label for="chapter_number" class="block text-gray-700">Chapter Number</label>
                    ...
                    <!-- Price -->
                    <div class="mb-4">
                        <label for="price" class="block text-gray-700">Price (Coins)</label>
                    ...
                    <!-- Pages upload -->
                    <div class="mb-4">
                        <label for="images" class="block text-gray-700">Upload Pages</label>
